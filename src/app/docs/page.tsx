import { ArrowRight, Globe, Key, Lock, Server, Shield } from "lucide-react";
      ...
      <section id="turnstile-setup" className="scroll-mt-24">
        ...
        <div className="not-prose space-y-4">
          <div className="flex items-center gap-4 p-4 bg-purple-500/10 rounded-xl">
            ...
            <div>
              <h3 className="font-medium text-white mb-1">Get Your API Keys</h3>
              <p className="text-sm text-slate-300">
                Visit the Cloudflare Dashboard to create a new Turnstile widget
                and get your Site and Secret keys.
              </p>
            </div>
          </div>
