  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="bg-slate-800/50 rounded-xl border border-slate-700/50 p-6">
        <div className="mb-4">
          <label htmlFor="notificationEmail" className="block text-sm font-medium text-slate-300 mb-2">
            Notification Email
          </label>
          <input
            type="email"
        ...
        <div className="mb-4">
          <label htmlFor="minimumOfferAmount" className="block text-sm font-medium text-slate-300 mb-2">
          ...
          <input
            ...
            onChange={(e) => setSettings({ ...settings, minimumOfferAmount: Number(e.target.value) })}
            className="w-full px-3 py-2 bg-slate-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
            min="0"
          />
        </div>
